...
async function getOwnedGoal(supabase, projectId, goalId) {
...
export async function PATCH(request, { params }) {
  ...
  const owned = await getOwnedGoal(supabase, projectId, goalId);
  ...
  const subgoals = [...(data.project_goal_subgoals || [])].sort(
